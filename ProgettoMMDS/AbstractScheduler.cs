...
namespace ProgettoMMDS
{
    abstract class AbstractScheduler
    {
        ...
        /// <returns>schedule su cui è stata effettuata la local search</returns>
        ...
        protected Schedule LocalSearchBestInsert(Schedule schedule)
        {
            ...
            while ((improvment > minImprovment) || (i < maxIterations))
            {
                ...
                while (tabuList.Contains(num1))
                    num1 = r.Next(maxInt);
                // QUi aggiungo l'elemento che ho appena selezionato alla tabù List e incremento l'indice della tabuList
                ...
                {
                    if ((num2 == num1)||(tabuList.Contains(num2)))
                        continue;
                    //SWAP
